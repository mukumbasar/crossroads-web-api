...
{
    public class ChatRoomMessageRepository : EFBaseRepository<ChatRoomMessage>, IChatRoomMessageRepository
    {
        public ChatRoomMessageRepository(CrossroadsDbContext context) : base(context)
        {
