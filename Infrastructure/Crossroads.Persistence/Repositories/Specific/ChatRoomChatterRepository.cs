...
{
    public class ChatRoomChatterRepository : EFBaseRepository<ChatRoomChatter>, IChatRoomChatterRepository
    {
        public ChatRoomChatterRepository(CrossroadsDbContext context) : base(context)
        {
