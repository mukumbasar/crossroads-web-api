...
namespace Crossroads.Application.Constants
{
    public class Messages
    {
        ...
        public const string AccountDeletionSucceeded = "Account deletion succeeded";
        public const string AccountNotFound = "Account not found";
        public const string ListHasNoAccounts = "List has no accounts";
        public const string AccountsListedSuccessfully = "Accounts listed successfully";
        public const string AccountFoundSuccessfully = "Account found successfully";
